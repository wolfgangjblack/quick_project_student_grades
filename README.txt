...
##### Lets do some T-tests to see if lunch or gender are different from the population, set threshold to 0.05. Then lets use anova to compare all three of the above (assuming the pvalue allows us to accept that lunch and gender are from the pop sample).
